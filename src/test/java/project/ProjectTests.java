...
public class ProjectTests {
    ...
    static final String PROJECT_NAME = "lero";
    static final String ACCOUNT_NAME = "lero";
    static final String NEW_PROJECT_NAME = "cando";
    static final String NEW_DESCRIPTION_NAME = "lero";
